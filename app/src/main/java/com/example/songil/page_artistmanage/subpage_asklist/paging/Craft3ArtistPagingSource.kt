...
class Craft3ArtistPagingSource(private val repository : ArtistManageAskListRepository, private var startIdx : KMutableProperty0<Int>, private var isRefresh : KMutableProperty0<Boolean>) : PagingSource<Int, Ask>() {
